...
abstract class NumberTriviaLocalDataSource {
  ...
  Set<NumberTriviaModel> getAllCachedNumbers();
...
class NumberTriviaLocalDataSourceImpl implements NumberTriviaLocalDataSource {
  ...
  @override
  Set<NumberTriviaModel> getAllCachedNumbers() {
    final setKeyValue = keyValueLocalDataSource.getKeyValues();
    final setNumberTriviaModel = setKeyValue.map((keyValue) {
      var valueCoded = json.decode(keyValue.value);
      return NumberTriviaModel.fromJson(valueCoded);
    });

    return setNumberTriviaModel.toSet();
  }
